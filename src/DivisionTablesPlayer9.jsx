...
export const DIVISION_TABLES_9_TOPIC_ID = "division-tables-9-v1";
...
export default function DivisionTablesPlayer({ user, topic, onHome }) {
  ...
  useActivityTracking(user, DIVISION_TABLES_9_TOPIC_ID, "Division Tables (9)");
  const topicId = topic?.id || DIVISION_TABLES_9_TOPIC_ID;
  ...
  const buildQuestionSet = (dIdx) => {
    ...
    const reviewDivisors = [2,3,4,5,6,7,8];
  ...
  if (completed) return (
    <div style={{ maxWidth: 520, margin: "0 auto", textAlign: "center" }}>
      <div className="card">
        ...
        <p style={{ fontSize: 20, color: "var(--text2)", marginBottom: 24 }}>You have mastered dividing by 9!</p>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", padding: "clamp(16px,3vw,32px)" }} className="dot-bg">
      <div style={{ maxWidth: 520, margin: "0 auto" }}>
        ...
        <div className="card">
          {phase === "question" && (
            <TimerBar key={timerKey} duration={timerDisabled ? 9999 : 10} onExpire={timerDisabled ? undefined : handleTimeout} />
          )}
