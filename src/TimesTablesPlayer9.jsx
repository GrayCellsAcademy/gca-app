...
export const TIMES_TABLES_9_TOPIC_ID = "times-tables-9-v1";
const N = 9;
const REVIEW_TABLES = [2,3,4,5,6,7,8];
const SKIP_GOAL = 30;
...
export default function TimesTablesPlayer9({ user, topic, onHome }) {
