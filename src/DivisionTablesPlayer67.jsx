...
export const DIVISION_TABLES_67_TOPIC_ID = "division-tables-67-v1";
...
export default function DivisionTablesPlayer({ user, topic, onHome }) {
  ...
  const buildQuestionSet = (dIdx) => {
    ...
    const reviewDivisors = [2,3,4,5,...DIVISORS.slice(0, dIdx)];
  ...
  if (completed) return (
    <div style={{ maxWidth: 520, margin: "0 auto", textAlign: "center" }}>
      <div className="card">
        ...
        <p style={{ fontSize: 20, color: "var(--text2)", marginBottom: 24 }}>You've mastered dividing by 6 and 7!</p>
