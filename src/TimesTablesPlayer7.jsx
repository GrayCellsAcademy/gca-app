...
export const TIMES_TABLES_7_TOPIC_ID = "times-tables-7-v1";
const N = 7;
const REVIEW_TABLES = [2,3,4,5,6];
const SKIP_GOAL = 30;
...
export default function TimesTablesPlayer7({ user, topic, onHome }) {
  const timerDisabled = user?.timerDisabled || false;
  useActivityTracking(user, "times-tables-7-v1", "Times Table (7)");
