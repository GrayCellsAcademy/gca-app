      ...
      {sorted.map(([ans, count]) => {
        ...
        return (
          <div key={ans} style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            {isCorrect && <span style={{ color: "var(--green)", fontSize: 20 }}></span>}
          </div>
        );
      })}
    </div>
...
function StudentClasswork({ session, sessionId, uid }) {
  ...
  if (session.status === "waiting") return (
    <div style={{ textAlign: "center", padding: "60px 20px" }}>
      ...
      <h2 style={{ fontSize: 28, fontWeight: 800, marginBottom: 8 }}>Waiting for teacher</h2>
      <p style={{ color: "var(--text2)", fontSize: 19 }}>Get ready  your teacher will push the first question soon.</p>
    </div>
  );
      ...
      <div className="card">
        ...
        {session.status === "revealing" ? (
          ...
          <div style={{ textAlign: "center", animation: "popIn 0.3s ease" }}>
            ...
            <div style={{ fontSize: 20, color: "var(--text3)", marginTop: 4 }}>Waiting for others</div>
          </div>
        ) : (
          <>
