...
export const DIVISION_TABLES_8_TOPIC_ID = "division-tables-8-v1";
...
export default function DivisionTablesPlayer({ user, topic, onHome }) {
  ...
  useActivityTracking(user, DIVISION_TABLES_8_TOPIC_ID, "Division Tables (8)");
  const topicId = topic?.id || DIVISION_TABLES_8_TOPIC_ID;
  ...
  const buildQuestionSet = (dIdx) => {
    ...
    const reviewDivisors = [2,3,4,5,6,7];
  ...
  if (completed) return (
    <div style={{ maxWidth: 520, margin: "0 auto", textAlign: "center" }}>
      <div className="card">
        ...
        <p style={{ fontSize: 20, color: "var(--text2)", marginBottom: 24 }}>You have mastered dividing by 8!</p>
